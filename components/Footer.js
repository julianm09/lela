...
export const Footer = ({ info }) => {
  return (
    <HeaderUI>
      <ContainerUI>
        <ColumnUI>
          <HeadingUI>Lê La</HeadingUI>

          <FooterTextUI>Authentic Vietnamese Cuisine</FooterTextUI>

          <FooterTextUI>
            Bay #4,
            <br />
            6624 Centre Street S.E. Calgary,
            <br />
            Alberta T2H 0C3
            <br />
          </FooterTextUI>
